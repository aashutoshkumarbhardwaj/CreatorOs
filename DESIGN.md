...
2. **Hover State (`:hover`):** 
   ...
   * Snap rotation to `0deg` (e.g., `hover:rotate-0`).
   ![Hover State](./assets/Hover_State.png)
3. **Active/Click State (`:active`):** 
   ...
   * Remove or shrink the shadow entirely: `shadow-none`.
   ![Pressed State](./assets/Pressed_State.png)
...
![Primary Button](./assets/Primary_Button.png)
...
![Secondary Button](./assets/Secondary_Button.png)
...
![Highlight Spans](./assets/Highlight_Spans.png)
...
![Feature Cards](./assets/Feature_Cards.png)
...
![Step Number Badge](./assets/Step_Number_Badge.png)
...
### 5.7 Form Inputs
![Text Input](./assets/Text_Input.png)
