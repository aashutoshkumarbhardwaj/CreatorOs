...
const analyticsSnapshotSchema = new mongoose.Schema(
    {
        ...
        following: { type: Number, default: 0, min: [0, 'following cannot be negative'] },
        totalPosts: { type: Number, default: 0, min: [0, 'totalPosts cannot be negative'] },
        totalLikes: { type: Number, default: 0, min: [0, 'totalLikes cannot be negative'] },
        totalComments: { type: Number, default: 0, min: [0, 'totalComments cannot be negative'] },
        totalViews: { type: Number, default: 0, min: [0, 'totalViews cannot be negative'] },
